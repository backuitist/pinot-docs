...
The Minion merge rollup task lets you merge small segments into larger ones. This helps to improve query performance and disk storage by aggregating data at a coarser granularity to reduce the data processed during query execution.
